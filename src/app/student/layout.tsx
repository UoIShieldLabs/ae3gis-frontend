...
import { Network, Settings, LogOut, Activity, ClipboardList, BookOpen } from "lucide-react";
import ThemeToggle from "../components/ThemeToggle";

const tabs = [
  { name: "Topologies", href: "/student/topologies", icon: Network },
  { name: "Scenarios", href: "/student/scenarios", icon: BookOpen },
  { name: "Telemetry", href: "/student/telemetry", icon: Activity },
