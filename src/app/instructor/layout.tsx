...
import { Network, BookOpen, Settings, LogOut, Users } from "lucide-react";
import ThemeToggle from "../components/ThemeToggle";

const tabs = [
  { name: "Topologies", href: "/instructor/topologies", icon: Network },
  { name: "Scenarios", href: "/instructor/scenarios", icon: BookOpen },
