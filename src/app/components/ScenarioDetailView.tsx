...
import { Scenario, ScenarioDefinition, ScenarioNode, EmbeddedScript } from "../types/topology";

interface ScenarioDetailViewProps {
  scenario: Scenario;
  onDefinitionChange?: (definition: ScenarioDefinition) => void;
  readOnly?: boolean;
}
...
export default function ScenarioDetailView({
  ...
  // Sync definition when scenario changes
  useEffect(() => {
    setDefinition(scenario.definition);
  }, [scenario]);
